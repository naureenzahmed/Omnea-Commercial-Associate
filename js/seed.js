...
function seedGtmExperiments() {
  ...
  return [
    { id: 'gtm-events-attended', title: 'Events Attended', fields: eventFields, entries: [] },
    {
      ...
      entries: [
        { id: uid('gtmrow'), event: 'Operator Panels', date: '', location: '', targetDemographic: '', numberOfAttendees: '', leadsCreated: '', notes: 'No product pitch on stage' },
        { id: uid('gtmrow'), event: 'Dinner', date: '', location: '', targetDemographic: '', numberOfAttendees: '', leadsCreated: '', notes: '' },
        { id: uid('gtmrow'), event: 'Cocktail', date: '', location: '', targetDemographic: '', numberOfAttendees: '', leadsCreated: '', notes: '' },
        { id: uid('gtmrow'), event: 'CFO Series', date: '', location: '', targetDemographic: '', numberOfAttendees: '', leadsCreated: '', notes: '' },
      ],
